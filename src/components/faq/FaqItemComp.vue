<template>
    <section class="FaqItemComp">
        <b-container class="bv-example-row">
            <b-row>
                <!---------------- Start Ask Items -------------->
                <b-col cols="12" lg="6" class="faq-left">
                    <ul>
                        <li class="disease-item l-item active-ask">
                            <p>Coronavirus Disease 2019 Basics</p>
                            <font-awesome-icon :icon="['fas' , 'caret-right']" />
                        </li>
                        <li class="spread-item l-item">
                            <p>How It Spreads</p>
                            <font-awesome-icon :icon="['fas' , 'caret-right']" />
                        </li>
                        <li class="protect-item l-item">
                            <p>How to Protect Yourself</p>
                            <font-awesome-icon :icon="['fas' , 'caret-right']" />
                        </li>
                        <li class="Symptoms-item l-item">
                            <p>Symptoms & Testing</p>
                            <font-awesome-icon :icon="['fas' , 'caret-right']" />
                        </li>
                        <li class="Outbreak-item l-item">
                            <p>Outbreak in Your Community</p>
                            <font-awesome-icon :icon="['fas' , 'caret-right']" />
                        </li>
                        <li class="buster-item l-item">
                ...
                <!---------------- Start Answer Items -------------->
                <b-col cols="12" lg="6" class="faq-right">
                    <!-- disease -->
                    <div class="disease accordion">
                        <!-- disease item 1 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title active-title">What is a novel coronavirus?</h2>
                            <div class="accordion-answer">
                                <p>On February 11, 2020 the World Health Organization announced an official name for
                                    ...
                                    novel coronavirus” or “2019-nCoV”.</p>
                        ...
                        <!-- disease item 2 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Why is the disease being called coronavirus disease 2019, COVID-19?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- disease item 3 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">How can people help stop stigma related to COVID-19?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- disease item 4 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Why might someone blame or avoid individuals and groups?</h2>
                            <div class="accordion-answer">
                    ...
                    <!-- spread -->
                    <div class="spreadv hidden">
                        <!-- spread item 1 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title active-title">What is the source of the virus?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- spread item 2 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">How does the virus spread?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- spread item 3 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Can someone who has had COVID-19 spread the illness to others?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- spread item4 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Will warm weather stop the outbreak of COVID-19?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- spread item 5 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Can the virus that causes COVID-19 be spread through food, including refrigerated or frozen food?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- spread item 6 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">What is community spread?</h2>
                            <div class="accordion-answer">
                    ...
                    <div class="protect hidden">
                        <!-- protect item 1 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title active-title">What can I do to protect myself and prevent the spread of disease?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- protect item 2 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">What should I do if I had close contact with someone who has COVID-19?</h2>
                            <div class="accordion-answer">
                                ...
                                <p>Make sure that you understand and can help the patient follow their healthcare provider’s instructions for medication(s) and care. You should help the patient with basic needs in the home and provide support for getting groceries, prescriptions, and other personal needs.</p>
                                <p>Monitor the patient’s symptoms. If the patient is getting sicker, call his or her healthcare provider and tell them that the patient has laboratory-confirmed COVID-19. This will help the healthcare provider’s office take steps to keep other people in the office or waiting room from getting infected. Ask the healthcare provider to call the local or state health department for additional guidance. If the patient has a medical emergency and you need to call 911, notify the dispatch personnel that the patient has, or is being evaluated for COVID-19.</p>
                                <p>Household members should stay in another room or be separated from the patient as much as possible. Household members should use a separate bedroom and bathroom, if available.</p>
                            </div>
                        </div>
                        <!-- protect item 3 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Who is at higher risk for serious illness from COVID-19?</h2>
                            <div class="accordion-answer">
                                <p>Older adults and people of any age who have serious underlying medical conditions may be at higher risk for more serious complications from COVID-19. These people who may be at higher risk of getting very sick from this illness, includes:</p>
                            </div>
                        </div>
                        <!-- protect item 4 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">What should people at higher risk of serious illness with COVID-19 do?</h2>
                            <div class="accordion-answer">
                                <p>If you are at higher risk of getting very sick from COVID-19, you should: stock up on supplies; take everyday precautions to keep space between yourself and others; when you go out in public, keep away from others who are sick; limit close contact and wash your hands often; and avoid crowds, cruise travel, and non-essential travel. If there is an outbreak in your community, stay home as much as possible. Watch for symptoms and emergency signs. If you get sick, stay home and call your doctor. More information on how to prepare, what to do if you get sick, and how communities and caregivers can support those at higher risk is available on People at Risk for Serious Illness from COVID-19.</p>
                            </div>
                        </div>
                        <!-- protect item 5 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Should I wear a mask to protect myself?</h2>
                            <div class="accordion-answer">
                    ...
                    <!-- symptom -->
                    <div class="symptom hidden">
                        <!-- symptom item 1 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title active-title">What are the symptoms of COVID-19?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- symptom item 2 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Should I be tested for COVID-19?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- symptom item 3 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Where can I get tested for COVID-19?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- symptom item 4 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Can a person test negative and later test positive for COVID-19?</h2>
                            <div class="accordion-answer">
                    ...
                    <!-- outbreak -->
                    <div class="outbreak hidden">
                        <!-- outbreak item 1 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title active-title">How do I prepare my children in case of COVID-19 outbreak in our community?</h2>
                            <div class="accordion-answer">
                                <p>How do I prepare my children in case of COVID-19 outbreak in our community?</p>
                                <p>Children respond differently to stressful situations than adults</p>
                            </div>
                        </div>
                        <!-- outbreak item 2 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">What steps should parents take to protect children during a community outbreak?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- outbreak item 3 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Will schools be dismissed if there is an outbreak in my community?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- outbreak item 5 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Should I go to work if there is an outbreak in my community?</h2>
                            <div class="accordion-answer">
                    ...
                    <!-- buster -->
                    <div class="buster hidden">
                        <!-- buster item 1 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title active-title">COVID-19 virus can be transmitted in areas with hot and humid climates?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- buster item 2 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Cold weather and snow CANNOT kill the new coronavirus</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- buster item 3 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Taking a hot bath does not prevent the new coronavirus disease</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- buster item 4 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">The new coronavirus CANNOT be transmitted through mosquito bites.</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- buster item 5 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Are hand dryers effective in killing the new coronavirus?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- buster item 6 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Can an ultraviolet disinfection lamp kill the new coronavirus?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- buster item 7 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">How effective are thermal scanners in detecting people infected with the new coronavirus?</h2>
                            <div class="accordion-answer">
                        ...
                        <!-- buster item 8 -->
                        <div class="accordion-item">
                            <h2 class="accordion-title">Do vaccines against pneumonia protect you against the new coronavirus?</h2>
                            <div class="accordion-answer">
...
<div class="accordion" role="tablist">
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-1 variant="info">What is a novel coronavirus?</b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-2 variant="info">Why is the disease being called coronavirus disease 2019, COVID-19?</b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-3 variant="info">How can people help stop stigma related to COVID-19?</b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-1">
      <b-card-header header-tag="header" class="p-1" role="tab">
        <b-button block v-b-toggle.accordion-3 variant="info">Why might someone blame or avoid individuals and groups?</b-button>
      </b-card-header>
      <b-collapse id="accordion-3" accordion="my-accordion" role="tabpanel">
        <b-card-body>
          <b-card-text>
